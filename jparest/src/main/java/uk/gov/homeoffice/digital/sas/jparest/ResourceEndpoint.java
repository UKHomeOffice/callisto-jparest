...
public class ResourceEndpoint {
  ...
  public static final String CALL_ADD_RELATED_ONLY_ON_EXISTING_RESOURCES =
      "You can only call AddRelated on resources already passed to the Add method";

  public static final String RELATED_RESOURCE_ALREADY_ADDED =
      "Related resource has already been added";
  ...
  public void addRelated(Class<? extends BaseEntity> clazz, Class<?
      extends BaseEntity> relatedClazz, String path) {
