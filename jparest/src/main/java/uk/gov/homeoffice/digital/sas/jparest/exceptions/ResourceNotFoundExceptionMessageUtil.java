...
public final class ResourceNotFoundExceptionMessageUtil {
  ...
  private static final String DELETABLE_RELATED_RESOURCES_NOT_FOUND_ERROR_FORMAT =
      "No related %s resources removed as the "
        + "following related resources could not be found. Ids:[%s]";
  ...
  public static String deletableRelatedResourcesMessage(
      Class<?> resourceType, Collection<UUID> ids) {
