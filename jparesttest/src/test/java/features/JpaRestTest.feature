...
#    And I define the "records" request json with values "src/main/resources/payloads/request/post/records-save.json"
#    When as a tester I call the "SAVE" "records" endpoint with "tenantId" value "b7e813a2-bb28-11ec-8422-0242ac120002" and the parameter "records"
#    Then I should get 200 back
#    And The "items.id" value from the response "Array" is saved
#
#  Scenario: Test PUT call
#    And I define the "records" request json with values "src/main/resources/payloads/request/put/records-update.json"
#    When as a tester I call the "UPDATE" "records" endpoint with "tenantId" value "b7e813a2-bb28-11ec-8422-0242ac120002" and the parameter "records"
#    Then I should get 200 back
#    And The "items.id" value from the response "Array" is saved
