...
public class JpaRestApiClient {
     ...
     * @return Response
     */
    public Response Create(String service, String resource, String payload) {
     ...
     * @return Response
     */
    public Response Retrieve(String service, String resource, String filter) {
        String baseUrl = this.serviceRegistry.getService(service);
        String url = baseUrl + API_ROOT_PATH + resource;
     ...
     * @return Response
     */
    public Response Retrieve(String service, String resource, int reference) {
        return null;
    }
     ...
     * @return Response
     */
    public Response Update(String service, String resource, int reference, String payload) {
        return null;
    }
     ...
     * @return Response
     */
    public Response Delete(String service, String resource, int reference) {
        return null;
    }
